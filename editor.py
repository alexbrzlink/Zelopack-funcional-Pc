...
fornecedores_df = pd.read_csv("Uploads/fornecedores.csv")
...
def editor():
    ...
    return render_template('editor.html', empresas=empresas, produtos=produtos, marcas=marcas, fornecedores_df=fornecedores_df)
